    ...
    <div className="div-container">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
        {products.map((product) => (
          <div
            key={product.id}
            className="bg-white p-4 border-b border-gray-200 hover:shadow-md transition-shadow cursor-pointer"
      ...
      {allProducts.length > maxProducts && (
        <Link
          to="/products"
          className=" text-black cursor-pointer hover:text-primary/80 transition-colors "
        >
